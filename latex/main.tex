...
\label{sec:modificaciones_propuestas}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\columnwidth]{figures/componentes_y_conectores_propuesta_1.pdf}
...
\label{sec:apendice}
    ...
    \label{sec:resultados_completos_del_escenario_base}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\columnwidth]{figures/baseline_response_time}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\columnwidth]{figures/baseline_scenarios}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\columnwidth]{figures/baseline_endpoint_response_time}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\columnwidth]{figures/baseline_requests_state}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\columnwidth]{figures/baseline_resources}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\columnwidth]{figures/baseline_currency}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\columnwidth]{figures/baseline_net_currency}
